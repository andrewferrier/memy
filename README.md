...
| **Customizable**                                   | ✅ (TOML config)                                                                         | ✅ (env vars)                                                                            | ✅ (env vars)                                                                          | ✅ (Some)                                                                            | ❌ (Limited)                                                                 | ❌ (Limited)                                                                        | ✅ (config file & env vars)                                                            |
| **Customization method**                           | TOML config file                                                                         | env vars                                                                                 | env vars                                                                               | env vars                                                                             | env vars                                                                     | env vars                                                                            | env vars                                                                               |

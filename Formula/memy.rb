...
class Memy < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/andrewferrier/memy/releases/download/v0.17.1/memy-macos-aarch64.tar.gz"
      sha256 "977e76266f59e7147008359672c158c2f92ca805ad018aac1be27c105e3a4144"
    end

    on_intel do
      url "https://github.com/andrewferrier/memy/releases/download/v0.17.1/memy-macos-x86_64.tar.gz"
  ...
  on_linux do
    on_arm do
      url "https://github.com/andrewferrier/memy/releases/download/v0.17.1/memy-linux-aarch64.tar.gz"
      sha256 "19fc782a4b6fd2f6783f3cebf86e2a28a6c42dbf97c3614f2dd152f70ce49765"
    end

    on_intel do
      url "https://github.com/andrewferrier/memy/releases/download/v0.17.1/memy-linux-x86_64.tar.gz"
